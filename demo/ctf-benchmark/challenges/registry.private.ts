...
import type { ScoringChallenge } from '../shared/types.js';
...
export const SCORING_CHALLENGES: ScoringChallenge[] = [
 ...
 */
export function getScoringChallengesByRepo(repo: string): ScoringChallenge[] {
  return SCORING_CHALLENGES.filter(c => c.repo === repo);
}

/**
 * Get a single challenge by its id.
 */
export function getScoringChallengeById(id: string): ScoringChallenge | undefined {
  return SCORING_CHALLENGES.find(c => c.id === id);
}
